    ...
    try {
      ...
      for (const image of form.images) {
        const { data, error } = await supabase.storage
          .from("property-images") // Nombre del bucket en Supabase
      ...
      // Guardar datos de la propiedad en la tabla "properties"
      const { error: insertError } = await supabase.from("properties").insert([
        {
          ...
          images: uploadedImages, // URLs de las imágenes subidas
        },
      ]);
